...
namespace MobileBackend.Models.CIBILRespone
{
    ...
    {
        public PANMessage PANMessage { get; set; }
    }
    ...
    public class NSDLPANStatusDesc
    {
    }

    public class NSDLLstUpdtDtITD
    {
    }

    public class NSDLPANStatus
    {
    }

    public class NSDLAadhaarSeedingStatus
    {
    }
    ...
    public class PAN
    {
        public NSDLPANStatusDesc NSDL_PAN_Status_Desc { get; set; }
        public string NSDL_Return_Cd_Desc { get; set; }
        public NSDLLstUpdtDtITD NSDL_LstUpdtDt_ITD { get; set; }
        public NSDLPANStatus NSDL_PAN_Status { get; set; }
        public string NSDL_Return_Cd { get; set; }
        public NSDLAadhaarSeedingStatus NSDL_Aadhaar_seeding_status { get; set; }
